...
Revision ID: 3bc15b17aff5
Revises: 
Create Date: 2024-01-31 11:41:53.741480
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['adventureId'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('friends', schema='adventure_time')
